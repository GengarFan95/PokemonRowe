const struct Trainer gTrainers[] = {
   ...
   [TRAINER_PKMN_RANGER_LOGAN] = {
    ...
    [TRAINER_PSS_TRAINER] =
    {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_PSSTrainer),
        .party = {.NoItemCustomMoves = sParty_PSSTrainer},
    },
    [TRAINER_PASSWORD_TRAINER] =
    {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_PasswordTrainer),
        .party = {.NoItemCustomMoves = sParty_PasswordTrainer},
    },
};
